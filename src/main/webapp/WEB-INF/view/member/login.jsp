		...
		<section class="login-main-section">
			<header>
				...
				<div class="login-intro">
					<span>반갑습니다</span> <img src="../images/logo.png"><span>입니다.</span>
				</div>
			</header>
			...
			<div class="login-check">
				<input class="d-none" type="checkbox" id="id-check"><label
					for="id-check"></label> <span class="id-check-label">아이디 저장</span>
			</div>
